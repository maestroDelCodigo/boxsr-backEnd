...
coleccionController.crearColeccion = (req, res) => {
    ...
    let sql = `INSERT INTO coleccion (nombre,deleted,video_url,precio_rebajado,precio_original, descripcion, descripcion_sirve, descripcion_usa, descripcion_ingredientes, descripcion_resumen)
 VALUES ('${nombre}','${deleted}','${video_url}',${precio_rebajado}, ${precio_original}, '${descripcion}', '${descripcion_sirve}', '${descripcion_usa}', '${descripcion_ingredientes}', '${descripcion_resumen}')`;
...
coleccionController.listaColecciones = (req, res) => {
    ...
    let sql = `SELECT C.coleccion_id, C.nombre, C.deleted, C.video_url, C.precio_rebajado, C.precio_original, C.descripcion, C.descripcion_sirve, C.descripcion_usa, C.descripcion_ingredientes, C.descripcion_resumen,  path as nombre_imagen
    FROM coleccion as C
...
coleccionController.modificarColeccion = (req, res) => {
    ...
    let sql = `UPDATE coleccion SET nombre ='${nombre}', deleted=${deleted},
     video_url='${video_url}', precio_rebajado=${precio_rebajado}, precio_original=${precio_original}, descripcion = '${descripcion}', descripcion_sirve = '${descripcion_sirve}', descripcion_usa = '${descripcion_usa}', descripcion_ingredientes = '${descripcion_ingredientes}', descripcion_resumen = '${descripcion_resumen}'
